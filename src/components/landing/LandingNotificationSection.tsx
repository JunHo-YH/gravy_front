...
export const LandingNotificationSection: React.FC<LandingNotificationSectionProps> = ({
  ...
  return (
    <div className={`bg-gradient-to-br from-gray-900 via-black to-gray-900 rounded-2xl shadow-2xl border-2 border-red-900/30 p-12 mb-16 transform transition-all duration-1000 ${
      isVisible
        ? 'translate-y-0 opacity-100 scale-100 notification-section-appear'
        : 'translate-y-8 opacity-0 scale-95'
    }`}>
      <div className={`text-center mb-8 transform transition-all duration-800 ${
        isVisible
        ...
        <h2 className="text-4xl font-black mb-4">
          ...
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-red-600">경매 알림</span>
        </h2>
        <p className="text-xl text-gray-400">지금 진행 중인 경매 상황을 확인해보세요</p>
      </div>
