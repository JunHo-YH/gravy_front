...
export const LandingNotificationSection: React.FC<LandingNotificationSectionProps> = ({
  ...
  return (
    <div className={`bg-white rounded-2xl shadow-lg p-12 mb-16 transform transition-all duration-1000 ${
      isVisible 
      ...
      <div className={`text-center mb-8 transform transition-all duration-800 ${
        ...
        <h2 className="text-4xl font-bold mb-4">
          <span className="text-gray-900">실시간 </span>
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-500 to-amber-600">경매 알림</span>
        </h2>
        <p className="text-xl text-gray-600">지금 진행 중인 경매 상황을 확인해보세요</p>
      </div>
